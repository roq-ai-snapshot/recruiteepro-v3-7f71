...
-- AddForeignKey
ALTER TABLE "feedback" ADD CONSTRAINT "feedback_job_application_id_fkey" FOREIGN KEY ("job_application_id") REFERENCES "job_application"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
