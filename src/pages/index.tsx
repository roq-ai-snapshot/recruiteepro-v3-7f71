...
function HomePage() {
  return (
    <>
      <Head>
        <title>RecruiteePro v3</title>

        <meta
          name="description"
          content="Empower your hiring journey with RecruiteePro v3 - the ultimate talent acquisition platform for seamless resume collection, efficient applicant tracking, and smooth onboarding experiences."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower your hiring journey with RecruiteePro v3 - the ultimate talent acquisition platform for seamless resume collection, efficient applicant tracking, and smooth onboarding experiences.`}
            </Text>
